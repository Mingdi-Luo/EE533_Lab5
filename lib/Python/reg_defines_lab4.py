...
def DEVICE_PROJ_DESC ():
    return "Group13: router with pipeline datapath IP"
...
def PIPE_IMEM_INTERACT_REG ():    
    return 0x2000300

def PIPE_IMEM_WRITE_REG ():       
    return 0x2000304

def PIPE_IMEM_RW_ADDRESS_REG ():  
    return 0x2000308

def PIPE_IMEM_WDATA_REG ():       
    return 0x200030c

def PIPE_DMEM_INTERACT_REG ():    
    return 0x2000310

def PIPE_DMEM_WRITE_REG ():       
    return 0x2000314

def PIPE_DMEM_RW_ADDRESS_REG ():  
    return 0x2000318

def PIPE_DMEM_WDATA_UPPER_REG (): 
    return 0x200031c

def PIPE_DMEM_WDATA_LOWER_REG (): 
    return 0x2000320

def PIPE_IMEM_RDATA_REG ():       
    return 0x2000324

def PIPE_DMEM_RDATA_UPPER_REG (): 
    return 0x2000328

def PIPE_DMEM_RDATA_LOWER_REG (): 
    return 0x200032c
...
__main__.nf_regmap.update({
    ...
    0x2000300 : "PIPE_IMEM_INTERACT_REG",
    0x2000304 : "PIPE_IMEM_WRITE_REG",
    0x2000308 : "PIPE_IMEM_RW_ADDRESS_REG",
    0x200030c : "PIPE_IMEM_WDATA_REG",
    0x2000310 : "PIPE_DMEM_INTERACT_REG",
    0x2000314 : "PIPE_DMEM_WRITE_REG",
    0x2000318 : "PIPE_DMEM_RW_ADDRESS_REG",
    0x200031c : "PIPE_DMEM_WDATA_UPPER_REG",
    0x2000320 : "PIPE_DMEM_WDATA_LOWER_REG",
    0x2000324 : "PIPE_IMEM_RDATA_REG",
    0x2000328 : "PIPE_DMEM_RDATA_UPPER_REG",
    0x200032c : "PIPE_DMEM_RDATA_LOWER_REG",
