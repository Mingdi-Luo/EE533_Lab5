...
#
# Project: Pipeline router (lab4)
# Description: Group13: router with pipeline datapath IP
#
#############################################################
...
@EXPORT = qw(
                ...
                IN_ARB_STATE_REG
                PIPE_IMEM_INTERACT_REG
                PIPE_IMEM_WRITE_REG
                PIPE_IMEM_RW_ADDRESS_REG
                PIPE_IMEM_WDATA_REG
                PIPE_DMEM_INTERACT_REG
                PIPE_DMEM_WRITE_REG
                PIPE_DMEM_RW_ADDRESS_REG
                PIPE_DMEM_WDATA_UPPER_REG
                PIPE_DMEM_WDATA_LOWER_REG
                PIPE_IMEM_RDATA_REG
                PIPE_DMEM_RDATA_UPPER_REG
                PIPE_DMEM_RDATA_LOWER_REG
                OQ_QUEUE_0_CTRL_REG
...
sub DEVICE_PROJ_NAME () { "Pipeline router"; }
sub DEVICE_PROJ_DESC () { "Group13: router with pipeline datapath IP"; }
...
# Name: pipeline_datapath (PIPE)
# Description: Registers for Pipeline Datapath IP
# File: projects/lab4/include/pipeline_datapath.xml
sub PIPE_IMEM_INTERACT_REG ()      { 0x2000300;}
sub PIPE_IMEM_WRITE_REG ()         { 0x2000304;}
sub PIPE_IMEM_RW_ADDRESS_REG ()    { 0x2000308;}
sub PIPE_IMEM_WDATA_REG ()         { 0x200030c;}
sub PIPE_DMEM_INTERACT_REG ()      { 0x2000310;}
sub PIPE_DMEM_WRITE_REG ()         { 0x2000314;}
sub PIPE_DMEM_RW_ADDRESS_REG ()    { 0x2000318;}
sub PIPE_DMEM_WDATA_UPPER_REG ()   { 0x200031c;}
sub PIPE_DMEM_WDATA_LOWER_REG ()   { 0x2000320;}
sub PIPE_IMEM_RDATA_REG ()         { 0x2000324;}
sub PIPE_DMEM_RDATA_UPPER_REG ()   { 0x2000328;}
sub PIPE_DMEM_RDATA_LOWER_REG ()   { 0x200032c;}
